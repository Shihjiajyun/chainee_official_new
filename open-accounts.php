...
<head>
    ...
    <link rel="stylesheet" href="./css/open-accounts.css">
</head>
...
<body>
    ...
    <div class="py-5">
        ...
        <div class="text-center">
            <a class="btn btn-primary p-2" href="#" id="readAll">查看所有「學開戶 - 新手入門」文章</a>
        </div>
    </div>
    ...
    <div class="py-5">
        <div class="container py-5" id="article_new" style="height:auto;">
            <!-- Section Title -->
            <h2 class="section-title"><span class="text-background">台幣交易所</span></h2>
        ...
        <div class="text-center">
            <a class="btn btn-primary p-2" href="#" id="readAll">查看所有「學開戶 - 台幣交易所」文章</a>
        </div>
    </div>
    ...
    <div class="py-5">
        <div class="container py-5" id="article_new" style="height:auto;">
            <!-- Section Title -->
            <h2 class="section-title"><span class="text-background">國際交易所</span></h2>
        ...
        <div class="text-center">
            <a class="btn btn-primary p-2" href="#" id="readAll">查看所有「學開戶 - 國際交易所」文章</a>
        </div>
    </div>
