...
<div class="container mt-4">
    ...
    <form id="edit-article-form" action="php/update_subscriptions_article.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" name="preview_text" rows="3" required><?= htmlspecialchars($article['preview_text']) ?></textarea>
        </div>

        <!-- 文章主要圖片 -->
        <div class="mb-3">
            <label class="form-label">文章預覽圖片</label><br>
            <input type="file" class="form-control" name="preview_image" accept="image/*" onchange="previewImage(event)">
            <img src="<?= htmlspecialchars($article['preview_image'] ?: 'https://via.placeholder.com/300x180') ?>" class="preview-img" id="preview-image">
        ...
        <div class="mb-3">
            ...
            <textarea name="markdown_content" id="markdown-content" style="display:none;"><?= htmlspecialchars($article['markdown_content']) ?></textarea>
        </div>
...
<script>
    ...
    const editor = new toastui.Editor({
        ...
        initialValue: document.getElementById("markdown-content").value
    });
