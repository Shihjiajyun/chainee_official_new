...
<head>
    ...
    <link rel="stylesheet" href="./css/find-deals.css">
</head>
...
<body>
    ...
    <div class="py-5">
        <div class="container py-5" id="article_new" style="height:auto;">
            ...
            <h2 class="section-title"><span class="text-background">交易所開戶大禮包</span></h2>
        ...
        <div class="text-center">
            <a class="btn btn-primary p-2" href="#" id="readAll">查看所有「撿好康 - 交易所開戶大禮包」文章</a>
        </div>
    </div>
    ...
    <div class="py-5">
        <div class="container py-5" id="article_new" style="height:auto;">
            <!-- Section Title -->
            <h2 class="section-title"><span class="text-background">幣圈天上掉錢下來</span></h2>
        ...
        <div class="text-center">
            <a class="btn btn-primary p-2" href="#" id="readAll">查看所有「撿好康 - 幣圈天上掉錢下來」文章</a>
        </div>
    </div>
