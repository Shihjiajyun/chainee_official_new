...
<head>
    ...
    <link rel="stylesheet" href="./css/learn-investing.css">
</head>
...
<body>
    ...
    <div class="py-5">
        <div class="container py-5" id="article_new" style="height:auto;">
            ...
            <h2 class="section-title"><span class="text-background">新手入門</span></h2>
        ...
        <div class="text-center">
            <a class="btn btn-primary p-2" href="#" id="readAll">查看所有「學投資 - 新手入門」文章</a>
        </div>
    </div>
    ...
    <div class="py-5">
        <div class="container py-5" id="article_new" style="height:auto;">
            <!-- Section Title -->
            <h2 class="section-title"><span class="text-background">投資心態&觀念</span></h2>
        ...
        <div class="text-center">
            <a class="btn btn-primary p-2" href="#" id="readAll">查看所有「學投資 - 投資心態&觀念」文章</a>
        </div>
    </div>
    ...
    <div class="py-5">
        <div class="container py-5" id="article_new" style="height:auto;">
            <!-- Section Title -->
            <h2 class="section-title"><span class="text-background">低風險！小資理財術</span></h2>
        ...
        <div class="text-center">
            <a class="btn btn-primary p-2" href="#" id="readAll">查看所有「學投資 - 低風險！小資理財術」文章</a>
        </div>
    </div>
    ...
    <div class="py-5">
        <div class="container py-5" id="article_new" style="height:auto;">
            <!-- Section Title -->
            <h2 class="section-title"><span class="text-background">高獲利！積極投資術</span></h2>
        ...
        <div class="text-center">
            <a class="btn btn-primary p-2" href="#" id="readAll">查看所有「學投資 - 高獲利！積極投資術」文章</a>
        </div>
    </div>
    ...
    <div class="py-5">
        <div class="container py-5" id="article_new" style="height:auto;">
            <!-- Section Title -->
            <h2 class="section-title"><span class="text-background">幣圈歷史大事</span></h2>
        ...
        <div class="text-center">
            <a class="btn btn-primary p-2" href="#" id="readAll">查看所有「學投資 - 幣圈歷史大事」文章</a>
        </div>
    </div>
