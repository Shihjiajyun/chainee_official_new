...
<body>
            ...
            <div class="col-lg-4 order-1 order-lg-2" id="price">
                <div class="price-card">
                    ...
                    <div class="d-flex gap-2 mt-3">
                        <button class="buy-button" onclick="redirectToCart()">立即購買</button>
                    </div>
                </div>
    ...
    function redirectToCart() {
        ...
        const courseData = {
            ...
            title: <?php echo json_encode($course['course_name']); ?>,
            price: <?php echo $course['discounted_price']; ?>,
            image: <?php echo json_encode($course['course_image']); ?>
        };

        // 將課程數據編碼並添加到 URL 中
        const params = new URLSearchParams({
            add_to_cart: JSON.stringify(courseData)
        });

        // 跳轉到購物車頁面
        window.location.href = 'test.php?' + params.toString();
    }
    </script>
