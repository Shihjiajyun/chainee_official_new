    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const courses = {
            beginner: [{
                ...
                {
                    title: "操作實務篇 | 投資加密貨幣，懂這些就夠了！",
                    category: "advanced",
                    image: "https://chainee.io/wp-content/uploads/2025/02/%E5%85%8D%E8%B2%BB%E8%AC%9B%E5%BA%A7_2_0.jpg",
                    provider: "鏈習生加密學院",
                    type: "幣圈初心者",
                    id: 3
                }
        ...
        function updatePage(category) {
            ...
            setTimeout(() => {
                if (category === "all") {
                    ...
                    displaySection(stepsContainer, `成為 ${categoryNames[category]} 的簡單三步驟`, steps[
                        category]);
                    displaySection(benefitsContainer, `成為 ${categoryNames[category]} 你可以獲得的三個東西`,
                        benefits[category]);
                }
        ...
        function displayCourses(category) {
            ...
            const filteredCourses = category === "all" ? [].concat(...Object.values(courses)) : courses[
                category] || [];
